...
import { EdukasiContext } from "../contexts/edukasiContext";
import { useParams, useNavigate } from "react-router-dom";
import Cookies from "js-cookie";
import axios from "axios";

let EdukasiApi = () => {
    const { state, handleFunction } = useContext(EdukasiContext)
    ...
    useEffect(() => {
        ...
        if (variableIdData !== undefined) {
            axios.get(`https://faiz-web.my.id/api/edukasis/${variableIdData}`)
                .then((res) => {
                    let data = res.data
